...
class AddHomeSCs_userOrderBuilds extends userOrderBuilds {
		...
		if( $this->type == 'Build Army' )
		{
			...
			return $this->sqlCheck("SELECT t.id
				...
				WHERE ts.gameID = ".$this->gameID."
					...
					AND (t.countryID = ".$this->countryID." OR t.name IN ('".implode("','", $addSCs)."'))
...
class ChesspolitikVariant_userOrderBuilds extends AddHomeSCs_userOrderBuilds {}
