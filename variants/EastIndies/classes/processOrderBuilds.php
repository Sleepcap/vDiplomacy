...
/*
	...
	This file is part of the BuildAnywhere variant for webDiplomacy

	The BuildAnywherevariant for webDiplomacy is free software: you can redistribute
	it and/or modify it under the terms of the GNU Affero General Public License 
	as published by the Free Software Foundation, either version 3 of the License,
	or (at your option) any later version.

	The BuildAnywhere variant for webDiplomacy is distributed in the hope that it will be
...
class EastIndiesVariant_processOrderBuilds extends BuildAnywhere_processOrderBuilds {}
